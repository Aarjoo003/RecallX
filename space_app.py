...
Serves the FastAPI retrieval engine on Hugging Face Spaces (Gradio SDK).
"""
...
# Put backend at the front of sys.path so 'app' always refers to backend/app
...
try:
    ...
    with gr.Blocks(title="RecallX Semantic Retrieval Engine") as demo:
        ...
        gr.Markdown(
            "### 🟢 API Status: Active\n\n"
            "FastAPI retrieval backend is live with 5,207 indexed messages.\n\n"
